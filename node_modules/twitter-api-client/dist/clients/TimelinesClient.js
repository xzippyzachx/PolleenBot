...
var TimelinesClient = /** @class */ (function () {
    function TimelinesClient(transport) {
        if (!transport) {
     ...
     * @param parameters
     */
    TimelinesClient.prototype.usersIdTweets = function (parameters) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.transport.doGetRequest('https://api.twitter.com/2/users/' + parameters.id + '/tweets' + params)];
...
exports.default = TimelinesClient;
