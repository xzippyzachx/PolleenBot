...
var TweetsV2Client = /** @class */ (function () {
     ...
     * @param parameters
     */
    TweetsV2Client.prototype.countRecentTweets = function (parameters) {
        return __awaiter(this, void 0, void 0, function () {
            var params;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        params = utils_1.createParams(parameters);
                        return [4 /*yield*/, this.transport.doGetRequest('https://api.twitter.com/2/tweets/counts/recent' + params)];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
        });
     ...
     * @param parameters
     */
    TweetsV2Client.prototype.countAllTweets = function (parameters) {
        return __awaiter(this, void 0, void 0, function () {
            var params;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        params = utils_1.createParams(parameters);
                        return [4 /*yield*/, this.transport.doGetRequest('https://api.twitter.com/2/tweets/counts/all' + params)];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
        });
